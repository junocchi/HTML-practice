Download the ZIP file below containing HTML and image files. Modify index.html to create a webpage based on the news article about rattlesnakes and their babies.
